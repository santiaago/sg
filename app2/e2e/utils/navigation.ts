...
export async function goToSection(
  page: Page,
  section: typeof SECTION_SQUARE_DSL | typeof SECTION_SIXFOLD_DSL_V1,
): Promise<void> {
  const testId = section === SECTION_SQUARE_DSL ? "nav-square-dsl" : "nav-sixfold-dsl-v1";
  const sectionSelector = section === SECTION_SQUARE_DSL ? "#square-dsl" : "#sixfold-dsl-v1";
  const svgTestId = section === SECTION_SQUARE_DSL ? "square-dsl-svg" : "sixfold-dsl-v1-svg";
...
export async function resetApp(
  page: Page,
  section: typeof SECTION_SQUARE_DSL | typeof SECTION_SIXFOLD_DSL_V1 = SECTION_SIXFOLD_DSL_V1,
): Promise<void> {
  await goToSection(page, section);
