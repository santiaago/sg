/**
 * Number 3 geometric construction (Three Circles)
 * Shared base construction + three circles
 */
...
/**
 * Build Number 3 (Three Circles) construction steps using the DSL.
 */
export function buildNumber3Steps(renderer?: GeometryRenderer): Step<NumberConfig>[] {
  ...
  // Step 8: Circle at midpoint
  builder.circle("circle3", midpoint, radius1.value);
...
/** Number of steps in Number 3 construction */
export const NUMBER_3_STEPS_LENGTH = 9;
