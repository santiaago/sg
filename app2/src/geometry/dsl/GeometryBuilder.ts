...
export class GeometryBuilder<TConfig> {
   ...
   * @param flipX - Optional flip/mirror on the x-axis (number, config key, or feature reference) (default: false)
   * @param flipY - Optional flip/mirror on the y-axis (number, config key, or feature reference) (default: false)
