...
/**
 * SixFoldDslV2Svg component - Renders the SVG canvas for SixFold v2 geometry using the new DSL implementation with cs2 and flipX.
...
export const SixFoldDslV2Svg = forwardRef(function SixFoldDslV2Svg(
  ...
  // v2 uses the same config as v0/v1
