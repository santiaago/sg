...
export function Square({
  ...
  useEffect(() => {
    ...
    // draw first line
    const mainLine = lineWithTooltip(svg, lx1, ly1, lx2, ly2, "line_main", stroke);
    if (store) {
    ...
    const cy1 = ly2;
    const r = ((lx2 - lx1) * 2) / 8;
    const circle1 = circleWithTooltip(svg, cx1, cy1, r, "c1_c", stroke);
    ...
    const cx2 = cx1 - r;
    const cy2 = cy1;
    const circle2 = circleWithTooltip(svg, cx2, cy2, r, "c2_c", stroke);
