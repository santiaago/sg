...
export function SixFold({
  ...
  const drawIntersectionPoints = (svg: SVGSVGElement, circles: any[]) => {
    ...
    const [pic12nx, pic12ny] = cerclesIntersection(cx1, cy1, r, cx2, cy2, r, directions.up);

    const [pic14x, pic14y] = cerclesIntersection(cx4, cy4, r, cx1, cy1, r, directions.left);
  ...
  useEffect(() => {
    ...
    const [pi3x, pi3y] = cerclesIntersection(pic14x, pic14y, d1, cx2, cy2, d1, directions.right);
    // find intersection point
    const [pi4x, pi4y] = cerclesIntersection(pic12nx, pic12ny, d1, cx4, cy4, d1, directions.right);
    ...
    let prx5, pry5;
    let pi5 = inteceptCircleLineSeg(pic14x, pic14y, cx1, cy1, pic14x, pic14y, d1);
    if (pi5 && pi5.length > 0) {
      [prx5, pry5] = pi5[0];
      dotWithTooltip(svg, prx5, pry5, "prx5", stroke);
    }
    let prx6, pry6;
    let pi6 = inteceptCircleLineSeg(pic12nx, pic12ny, cx1, cy1, pic12nx, pic12ny, d1);
    if (pi6 && pi6.length > 0) {
      [prx6, pry6] = pi6[0];
    ...
    let cx34, cy34, d2;
    {
      ...
      const [px, py] = lineIntersect(cx3, cy3, cx4, cy4, pic12nx, pic12ny, x, y);
