...
export default function App(): JSX.Element {
  ...
  // Clean up interval on unmount for v2
  useEffect(() => {
    return () => {
      if (playIntervalSixfoldDslV2.current) {
        clearInterval(playIntervalSixfoldDslV2.current);
  ...
  return (
    <main className="p-8 bg-gray-900 text-white">
      ...
      >
        ...
        <div className="mb-4">
          <small className="block text-gray-400 mb-2">05/20/2026</small>
          <p className="text-gray-300 mb-4">
            SixFold v2 construction using DSL with cs2 coordinate system and flipX ({visualStepCountV2} visual
            steps).
          </p>
        </div>
        <div className="grid grid-cols-12 gap-8">
