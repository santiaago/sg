  ...
  return (
    <main className="p-8 bg-gray-900 text-white">
      ...
      >
        ...
        <div className="mb-4">
          <small className="block text-gray-400 mb-2">05/30/2026</small>
          <p className="text-gray-300 mb-4">
            SixFold v2 construction using DSL with cs2 coordinate system and flipX=true ({visualStepCountV2} visual
            steps). Mirrored variant of v1.
          </p>
        </div>
        <div className="grid grid-cols-12 gap-8">
          <div className="col-span-7">
