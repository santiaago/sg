...
import { buildSixfoldDslV1Steps, DSL_SIXFOLD_V1_STEPS_LENGTH } from "../src/geometry/sixfoldDslV1Steps";
...
describe("SixFold DSL v1 - outline18 not displayed", () => {
  ...
  it("now passes: outline18 IS in allValues when executing with +1 fix", () => {
    ...
    const allValues = executeSteps(steps, actualIndex, { svg: mockSvg, store: mockStore, theme: {} }, config);
